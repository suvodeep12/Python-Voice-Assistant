...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            codePath = r"C:\\Users\\Suvo\\AppData\\Local\\Programs\\Opera\\launcher.exe"
            os.startfile(codePath)

        elif 'email to suvo' in query:
            try:
            ...
            speak("I have been created by Suvodeep.")
            ...
            speak("I am your virtual assistant created by Suvodeep")

        elif 'reason for you' in query:
            speak("I was created as a Minor project by Mister Suvodeep ")
